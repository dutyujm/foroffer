    ...
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            switch (operation) {
                ...
                case 1:{
                    ...
                    if (CheckMobilePhoneNum(phone.getPhoneNumber())) {
                        ...
                        if (phoneBook.addPhone(phone)) {
                            ...
                            System.out.println("添加失败，已存在相同电话号！");
                        }
                    }else {
                ...
                // 4是查看统计数量信息
                case 4:{
                    System.out.print("当前的数量是"+phoneBook.getPhoneNumber());
                    break;
                }
                // 5是打印所有电话信息
                case 5:{
